...
namespace Roslynator.VisualStudio
{
    public partial class RefactoringsOptionsPage
    {
        ...
        internal static void SetRefactoringsDisabledByDefault(RefactoringSettings settings)
        {
            ...
            settings.Disable(RefactoringIdentifiers.ReplaceForEachWithForAndReverseLoop);
        ...
        protected override void Fill(ICollection<BaseModel> refactorings)
        {
            ...
            refactorings.Add(new BaseModel(RefactoringIdentifiers.AddMissingPropertiesToObjectInitializer, "Add missing properties to object initializer", IsEnabled(RefactoringIdentifiers.AddMissingPropertiesToObjectInitializer)));
        }
    }
}