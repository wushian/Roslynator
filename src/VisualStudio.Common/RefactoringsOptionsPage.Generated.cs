...
namespace Roslynator.VisualStudio
{
    public partial class RefactoringsOptionsPage
    {
        ...
        protected override void Fill(ICollection<BaseModel> refactorings)
        {
            ...
            refactorings.Add(new BaseModel(RefactoringIdentifiers.ReplaceTupleWithStruct, "Replace tuple with struct", IsEnabled(RefactoringIdentifiers.ReplaceTupleWithStruct)));
        }
    }
}