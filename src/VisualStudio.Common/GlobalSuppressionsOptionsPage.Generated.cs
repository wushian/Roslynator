...
namespace Roslynator.VisualStudio
{
    public partial class GlobalSuppressionsOptionsPage
    {
        ...
        = DiagnosticIdentifiers.UseDefaultLiteral;
        protected override void Fill(ICollection<BaseModel> analyzers)
        {
            ...
            analyzers.Add(new BaseModel(DiagnosticIdentifiers.UseDefaultLiteral, "Use default literal.", !IsEnabled(DiagnosticIdentifiers.UseDefaultLiteral)));
        }
    }
}